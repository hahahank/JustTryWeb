...
def mcinfoParser(data):
    ...
    {'status': None, 'item': 'Manufacturer Name', 'value': ['Unknown (0x19A9)']}, {'status': None, 'item': 'Product ID', 'value': ['54 (0x0036)']}, {'status': None, 'item': 'Product Name', 'value': ['Unknown (0x36)']}, {'status': None, 'item': 'Device Available', 'value': ['yes']}, {'status': None, 'item': 'Provides Device SDRs', 'value': ['no']}, {'status': None, 'item': 'Additional Device Support', 'value': ['', 'Sensor Device', 'SDR Repository Device', 'SEL Device', 'FRU Inventory Device', 'IPMB Event Receiver', 'IPMB Event Generator', 'Chassis Device']}, 
